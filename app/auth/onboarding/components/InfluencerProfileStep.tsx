...
const influencerProfileSchema = z
  .object({
    socialLinks: z
      ...
      .refine(
        (data) => data.youtube || data.tiktok || data.instagram,
...
export default function InfluencerProfileStep({
  data,
  updateData,
  onNext,
  onPrev,
}: InfluencerProfileStepProps) {
    ...
    <Card className="shadow-lg border-0">
      <CardHeader>
        ...
        <p className="text-center text-gray-600 dark:text-gray-400">
          Tell us about your social presence and audience
        </p>
      </CardHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Provide at least one social media profile where you create
                content
              </p>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          placeholder="e.g., 750K followers across platforms"
                          className="h-11"
                        />
                      </FormControl>
                      <FormMessage />
            ...
            <div className="space-y-4">
              ...
              {selectedNiches.length === 0 && (
                <p className="text-sm text-red-600">
                  Please select at least one niche
                </p>
              )}
            </div>
